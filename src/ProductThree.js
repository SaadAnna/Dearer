...
export default function ProductThree(){
    return (
        ...
        <p>Classic long jeans made from durable denim. Featuring <br/>
         a comfortable fit and timeless style, perfect for everyday <br/>
          wear. Available in various sizes and washes.
        </p>
        <span>$51.99</span>
