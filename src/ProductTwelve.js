...
export default function ProductTwelve(){
    return (
        ...
        <div id="productDescritpion">
                ...
                <p> 
                Classic and stylish, this men's cap offers a comfortable fit with a<br/>
                 timeless design. Made from durable fabric, it's perfect for <br/>
                 everyday wear and adds a polished touch to any casual outfit. <br/>
